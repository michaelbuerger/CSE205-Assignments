...
// Description: Handles processing of user input and handling of function menu.
//              Allows user to add and remove guests, find its position, display menu, and quit.
                ...
                if (line.length() == 1)   //check if a user entered only one character
                {
                    switch (input1) {
                        ...
                        case 'P':
                            ...
                            //System.out.println("!!!!!!!!!!!!!!!!!!!!! " + result + " after searching " + input);
                            if(result == -1)
